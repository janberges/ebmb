...
\begin{document}
   ...
   \begin{table}[b]
      ...
      \begin{tabular}{*9l}
         ...
         \tt cutout     & $\omega_N$ & $\omega \sub E$   & $\omega_{N \sub C}$ & \textsc{Coulomb} cutoff frequency        & $+$ & $+$ & $+$ & $-$ \\[\gap]
         \tt lambda     & $\vec 1$   & 1                 & $\lambda_{i j}$     & electron-phonon coupling                 & $+$ & $+$ & $+$ & $+$ \\
         \tt muStar     & $\vec 0$   & 1                 & $\mu^*_{i j}$       & \textsc{Coulomb} pseudo-potential        & $+$ & $+$ & $+$ & $+$ \\[\gap]
         \tt dos        & \tt none   & --                & --                  & file with density of states              & $+$ & $+$ & $-$ & $-$ \\[\gap]
         ...
         \tt shift      & $10$       & 1                 & --                  & eigenvalue shift for power method        & $-$ & $-$ & $+$ & $-$ \\[\gap]
      ...
      \caption[Input parameters]{
         ...
         \begin{itemize}
            ...
            \item
               The file with the density of states $n_i(\epsilon)$ contains an
               integer $N$, followed by $N$ lines $\epsilon_l \ n_1(\epsilon_l)
               \ n_2(\epsilon_l) \ \dots$ where $l = 1 \dots N$ and $\epsilon_1
               \leq \dots \leq \epsilon_N$.
         \end{itemize}
         }
      \label{parameters}
   \end{table}
