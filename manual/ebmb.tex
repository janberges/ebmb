...
\begin{document}
      ...
      \item
         ...
         \begin{itemize}[itemsep=0pt]
            ...
            \item
               ...
               F_{2, 1}$ $\dots$ with $\omega$ increasing.
   ...
   \begin{table}[b]
      ...
      \begin{tabular}{*9l}
         ...
         \tt Sigma         & \tt false   & --               & --                  & calculate $\varSigma_{1 1 i}$?             & $+$ & $-$ & $-$ & $-$ \\[\gap]
         ...
         \tt eta, 0+       & $10^{-3}$   & eV               & --                  & infinitesimal energy $0^+$                 & $+$ & $-$ & $-$ & $-$ \\
         ...
         \tt etaIm0        & \tt true    & -- & -- & send $\eta \rightarrow 0^+$ in $\Im \varSigma_{1 1 i}(\omega + \I \eta)$? & $+$ & $-$ & $-$ & $-$ \\
   ...
   \begin{table}
      ...
      \begin{tabular}{*2l r}
         ...
         \tt Sigma  & normal self-energy (\#)~\texttt{Sigma=true} & $\varSigma_{1 1 i}(n)$ \\
         ...
         \tt \stack{l}{Re[Sigma]}{Im[Sigma]} & \stack{r}{real}{imaginary} $\Big\}$ normal self-energy (\#) & $\varSigma_{1 1 i}(\omega)$ \\
