...
\begin{document}
   ...
   \end{align*}
   %
   $n_i(\epsilon)$ is the density of \textsc{Bloch} states with energy
   $\epsilon$ per band and unit cell. $\mu$ and $\mu'$ are the chemical
   ...
   \begin{equation*}
      ...
      \frac{n_i(\epsilon)}{\E^{(\epsilon - \mu) / T} + 1}
      = n \overset ! = n'
   ...
   \end{equation*}
   %
   Approximating $n_i(\epsilon) \approx n_i(\mu)$ yields $\chi_i(n) = 0$ and the
   constant-DOS \textsc{Eliashberg} equations
   %
   \begin{equation}
      \begin{split}
   ...
   \begin{table}[b]
      ...
      \begin{tabular}{*9l}
         ...
         \tt n          & --          & 1                & $n$                 & initial occupancy number                 & $+$ & $+$ & $-$ & $-$ \\
         \tt mu         & 0           & eV               & $\mu$               & initial chemical potential               & $+$ & $+$ & $-$ & $-$ \\
   ...
   \begin{table}
      ...
      \begin{tabular}{*2l r}
         ...
         \hline
         \tt \stack{l}{n} {n'}  & \stack{r}{initial}{final} $\Big\}$ occupancy number   & \stack{r}{$n$}  {$n'$}   \\
         \tt \stack{l}{mu}{mu'} & \stack{r}{initial}{final} $\Big\}$ chemical potential & \stack{r}{$\mu$}{$\mu'$} \\
         \hline
