...
\begin{document}
   ...
   \begin{table}[b]
      ...
      \begin{tabular}{*9l}
         ...
         \tt gap           & \tt false   & --               & --                  & find measurable gap?                       & $+$ & $-$ & $-$ & $-$ \\[\gap]
         \tt unscale       & \tt true    & --               & --                  & estimate missing {\tt muC} from {\tt mu*}? & $+$ & $+$ & $+$ & $-$ \\
         \tt rescale       & \tt true    & --               & --                  & use $\mu^*_{i j}$ rescaled for cutoff?     & $+$ & $+$ & $+$ & $-$ \\
         \tt cdosfix       & \tt true    & --               & --   & use $D_i^\infty(n)$ in Eq.~\ref{linearized gap equation}? & $-$ & $-$ & $+$ & $-$ \\[\gap]
         ...
         \tt align0        & \tt false   & --               & --                & enforce $\chi_i(\I \eta) = \chi_j(\I \eta)$? & $+$ & $-$ & $-$ & $-$ \\[\gap]
