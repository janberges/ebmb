...
\begin{document}
   ...
   $\epsilon$ per band and unit cell. $\mu_0$ and $\mu$ are the corresponding
   and self-consistent chemical potentials, respectively. The latter ensures
   that the electron number is conserved:
   %
   \begin{align*}
      2 \sum_i \int \from{-\infty} \till \infty \D \epsilon
      \frac{n_i(\epsilon)}{\E^{(\epsilon - \mu_0) / T} + 1} \overset ! \approx 1
      - 4 T \sum_i \int \from{-\infty} \till \infty \D \epsilon \, n_i(\epsilon)
      \Bigg[
         \sum_{n = 0}^{N - 1}
   ...
   \begin{table}[b]
      ...
      \begin{tabular}{*9l}
         ...
         \tt mu         & 0           & eV               & $\mu_0$             & free-particle chemical potential         & $+$ & $+$ & $-$ & $-$ \\[\gap]
   ...
   \begin{table}
      ...
      \begin{tabular}{*2l r}
         ...
         \tt mu     & self-consistent chemical potential          & $\mu$             \\
